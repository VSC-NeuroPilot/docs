...
Neuro can ask for cookies (if the [Request Cookies permission](/docs/client/reference/permissions#request-cookies) is set to Copilot.)
...
She can also choose to grab a cookie herself if the permission is set to Autopilot. This is useful in solo coding situations, assuming of course she doesn't abuse her privilege.
