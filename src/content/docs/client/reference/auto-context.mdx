...
- Saving notifications (configurable via [this setting](/docs/client/reference/settings#send-save-notifications)).
- Auto-Save setting modification.
- Linting problems that appear automatically (configurable via [this setting](/docs/client/reference/settings#send-new-linting-problems-on)).
