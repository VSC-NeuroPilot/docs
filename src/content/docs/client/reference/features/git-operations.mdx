...
banner:
    content: |
        This feature set requires the <a href="/docs/client/reference/dependencies#git">Git</a> extension to be activated.
---
...
You can reinitiate these checks anytime using the [Get dependency extension states](/docs/client/commands#get-dependency-extension-states) command.
...
The prefix changes partially depending on the [Currently As Neuro API setting](/docs/client/reference/settings#currently-as-neuro-api).
