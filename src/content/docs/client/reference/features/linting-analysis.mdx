...
If the [Send New Linting Problems On](/docs/client/reference/settings#send-new-linting-problems-on) setting is set to a value other than 'Off', Neuro will be informed if a file has gotten new linting problems accordingly.
...
Find out more at [Features/Copilot features - Copilot Chat](/docs/client/reference/features/copilot-features#copilot-chat).
