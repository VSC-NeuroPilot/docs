...
When using `get_workspace_files` Neuro can specify if she wants it to recursively return files in the workspace, and she can also choose to narrow down to a specific folder.
...
See [Edit Active Document's feature list](/docs/client/reference/features/edit-active-document).
