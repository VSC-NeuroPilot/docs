...
**Tip**: for quick access to the workspace settings in Visual Studio Code: `Shift + Ctrl + p` -> `Preferences: Open Workspace Settings (JSON)`.
...
export const TERMINAL_ACCESS_SETTINGS = `{
    ...
    "neuropilot.access.dotFiles": true,
    "neuropilot.access.environmentVariables": true,
    "neuropilot.access.excludePattern": [
        "**/node_modules/**",
        "**/venv/**"
    ],
    "neuropilot.access.externalFiles": true,
