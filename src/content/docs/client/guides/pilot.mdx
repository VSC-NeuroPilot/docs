...
*See also the page on the [RCE framework](/docs/client/reference/rce).*
...
![Autopilot Demo](/docs/client/demo-autopilot.gif)
...
![Copilot Demo](/docs/client/demo-copilot.gif)
