...
This page is aimed at people wishing to contribute non-code assets to NeuroPilot (e.g. icons). Code assets should refer back to their [respective category](/docs/meta/contributors). 

</Aside>

## Showcase icons

- For security reasons, VS Code doesn't allow SVGs to be loaded (with exceptions). With that being said, we'd like an SVG version as well due to the [NeuroPilot Assets page](/docs/meta/assets) on docs.
