...
- [Extension (the `src/` folder in repo)](/docs/meta/contributors/extension)
- [Docs (the `docs/` folder in repo)](/docs/meta/contributors/docs)
- [Testing/demonstration (tooling stored in the `tony/` folder in repo)](/docs/meta/contributors/testing)
- [Assets (the `assets/` folder in both repo root and docs' `src/assets`/`public`)](/docs/meta/contributors/assets)
- [Meta (linting, CI, build tools, extension info, etc...)](/docs/meta/contributors/meta)
