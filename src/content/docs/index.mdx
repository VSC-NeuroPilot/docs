...
hero:
  ...
  actions:
    - text: Setup NeuroPilot
      link: /docs/client/guides/setup/
      icon: right-arrow
    - text: Download NeuroPilot
      link: https://marketplace.visualstudio.com/items?itemName=vsc-neuropilot.neuropilot-base
      icon: vscode
      variant: secondary
    - text: NeuroPilot (client) repository
      link: https://github.com/VSC-NeuroPilot/neuropilot
      icon: github
      variant: minimal
    - text: Issues
      link: https://github.com/VSC-NeuroPilot/neuropilot/issues
      icon: error
      variant: minimal
  image:
    html: |
...
<CardGrid>
  <LinkCard title="Discord thread" href="https://discord.com/channels/574720535888396288/1350968830230396938" description={`The thread on Neuro-sama Headquarters Discord where most things are discussed.`} />
  <LinkCard title="Docs directory" href={BASE_GITHUB_ORG + "/docs"} description="Source repository for the documentation pages." />
  <LinkCard title="Open extension listing in VS Code" href={MARKETPLACE_URL('direct')} />
  <LinkCard title="Neuro Game API official repo" href="https://github.com/VedalAI/neuro-game-sdk" />
</CardGrid>

## Terminology :badge[Important]{variant=danger}

<CardGrid>
	<Card title="Neuro-safe/Neuro-unsafe" icon="document">
		A set of directories Neuro is/isn't allowed to access.

    To find out about what directories are included, see [the File access restrictions section on the safety page](/docs/client/reference/safety#file-access-restrictions).
	</Card>
    ...
    For more info, see [the guides page on selecting a -pilot mode for a setting](/docs/client/guides/pilot).
	</Card>
    ...
    You can learn more and find the list [here](/docs/client/reference/auto-context).
	</Card>
	<Card title="RCE" icon="approve-check-circle">
    ...
    For how exactly this system works, read [this](/docs/client/reference/rce).
	</Card> {/* should I move this? */}
</CardGrid>

{/* I have an idea for quick links but this will be left like this for now */}
