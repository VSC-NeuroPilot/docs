...
import { BASE_GITHUB_URL, MARKETPLACE_URL } from '../../../consts/links.ts'
...
<CardGrid>
  ...
  <LinkCard title="Docs directory on repo" href={BASE_GITHUB_URL + "/tree/master/docs"} description="Source files for the documentation pages." />
  <LinkCard title="Open extension in VS Code" href={MARKETPLACE_URL('direct')} />
...
<CardGrid>
    ...
    To find out about what directories are included, see [the File access restrictions section on the safety page](/docs/reference/safety#file-access-restrictions).
	</Card>
    ...
    For more info, see [the guides page on selecting a -pilot mode for a setting](/docs/guides/pilot).
	</Card>
    ...
    You can learn more and find the list [here](/docs/reference/auto-context).
	</Card>
    ...
    For how exactly this system works, read [this](/docs/reference/rce).
	</Card>
</CardGrid>
