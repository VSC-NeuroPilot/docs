...
import { BASE_GITHUB_ORG, MARKETPLACE_URL } from '../../../consts/links.ts'
...
<CardGrid>
  <LinkCard title="Discord thread" href="" description={`The thread on Neuro-sama Headquarters Discord where most things are discussed.`} />
