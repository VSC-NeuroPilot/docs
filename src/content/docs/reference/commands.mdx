...
Learn more about these commands at [Features/Linting analysis - Ask Neuro to fix/explain](/docs/reference/features/linting-analysis#ask-neuro-to-fixexplain)

## Switch current Neuro API user name

Acts as a shortcut to the [Currently As Neuro API](/docs/reference/settings#currently-as-neuro-api) setting, allowing you to change it to whatever value you desire.
