...
If you can't decide which one to choose, [visit this page](/docs/guides/pilot).
...
To see the features covered by these permissions, go to [this page](/docs/reference/features/file-actions).
...
To see features covered by this permission, go to [this page](/docs/reference/features/edit-active-document).
...
To see features covered by these permissions, visit [this page](/docs/reference/features/git-operations).
...
This category covers actions that can execute commands in a shell. These requires some pre-defining, which you can learn more about [here](/docs/reference/features/shells).
...
To see features covered by this permission, visit [this page](/docs/reference/features/linting-analysis).
