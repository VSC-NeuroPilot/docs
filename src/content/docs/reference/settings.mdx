...
To find the list of permission-related settings, visit [this section on Reference/Permissions](/docs/reference/permissions#non-action-permissions).
...
You'll need to try to [reconnect](/docs/reference/commands) after changing this.
...
*See also: [Features/Shells - Terminals](/docs/reference/features/shells#terminals)*
...
*See also: [Features/Linting analysis - Automatic context updates](/docs/reference/features/linting-analysis#automatic-context-updates)

Defines when Neuro gets automatic context updates. This will send context independent of the [`Access Linting Analysis`](/docs/reference/permissions#linting-analysis) permission.
