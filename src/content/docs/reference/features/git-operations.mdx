...
banner:
    content: |
        This feature set requires the <a href="/docs/reference/dependencies#git">Git</a> extension to be activated.
---
...
You can reinitiate these checks anytime using the [Get dependency extension states](/docs/commands#get-dependency-extension-states) command.
...
The prefix changes partially depending on the [Currently As Neuro API setting](/docs/reference/settings#currently-as-neuro-api).
