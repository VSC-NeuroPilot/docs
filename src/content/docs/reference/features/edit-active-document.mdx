...
In addition to being informed if she saved successfully, enabling [Send Save Notifications](/docs/reference/settings#send-save-notifications) will allow Neuro to receive save notifications as the active document is saved. 

<Aside type="tip">

If you have enabled [Send Save Notifications](/docs/reference/settings#send-save-notifications), it will be temporarily disabled internally while she is saving manually.
