...
Neuro's virtual cursor is a pink cursor decoration that is visible whenever Neuro has any level of access to [editing the active document](/docs/reference/permissions#edit-active-document).
...
The user can manually move Neuro's cursor using the [Move Neuro's Cursor Here](/docs/reference/commands#move-neuros-cursor-here), and can also let her sync the real cursor with the virtual cursor using the [Cursor Follows Neuro](/docs/reference/settings#cursor-follows-neuro) setting.
